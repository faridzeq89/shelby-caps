...
class _SaleScreenState extends State<SaleScreen> {
  ...
  Future<void> _openSearch() async {
    final product = await showModalBottomSheet<Product>(
      ...
      builder: (_) => _ProductSearchSheet(catalog: _catalog),
    );
    ...
    final variant = await showModalBottomSheet<Variant>(
      context: context,
      isScrollControlled: true,
      builder: (_) => _VariantPickerSheet(catalog: _catalog, product: product),
    );
              ...
              child: ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  return ListTile(
                    title: Text(p.name),
                    subtitle:
                        p.brand != null ? Text(p.brand!) : null,
                    trailing: Text(
...
// ===========================================================================
// Selector de variante tipo e-commerce (paso 2): stock total, y talla/color
// con las combinaciones sin existencia desactivadas.
// ===========================================================================
...
class _VariantPickerSheetState extends State<_VariantPickerSheet> {
  List<(Variant, int)>? _variants; // (variante, disponible)
