  ...
  Widget build(BuildContext context) {
    ...
    final items = <_AdminItem>[
      ...
      _AdminItem(Icons.science_outlined, 'Catálogo de prueba',
          'Cargar o borrar gorras de ejemplo', AppColors.accent,
